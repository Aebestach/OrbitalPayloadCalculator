...
令人惊讶的是，KSP 已经十年之久了，却很少有人做过专门解决这个问题的工具。自己在设计火箭时也深有体会：不断对照 Delta-V 表计算载荷，既费脑又容易出错。正是这些需求和 ***痛点***，促使 **Orbital Payload Calculator** 的诞生。
...
-   **计算准确性说明**
    ...
    -   本 Mod 仍在持续完善中——它已经能帮你算 Delta-V，但还没聪明到替你拯救每一次 ***空气动力学灾难***。
